...
export default function OnsiteProgressScreen() {
  ...
  const handleSave = async () => {
    if (!note.trim()) {
      Alert.alert(
        "Note required",
        "Please add a technician note before saving.",
      );
      return;
    }
    setLoading(true);
    ...
    <View style={TechStyles.screen}>
      ...
      >
            ...
            return (
              ...
              >
                ...
                <View
                  style={[
                    styles.radioOuter,
                    selected && { borderColor: meta.color },
                  ]}
                >
                  {selected && (
                    <View
        ...
        <TechCard label="Technician note">
          <Text
            style={{ fontSize: 12, color: TechColors.text3, marginBottom: 10 }}
          >
        ...
        <TechCard label="Need assistance?">
          <Text
            style={{ fontSize: 13, color: TechColors.text2, marginBottom: 12 }}
          >
            ...
            {[false, true].map((val) => (
              <TouchableOpacity
                ...
                style={[
                  styles.assistBtn,
                  needAssistance === val && {
                    borderColor: val ? TechColors.red : TechColors.brand,
                    backgroundColor: val
                      ? TechColors.redBg
                      : TechColors.brandBg,
                  },
              ...
              >
                ...
                <Text
                  style={[
                    ...
                    needAssistance === val && {
                      color: val ? TechColors.red : TechColors.brand,
                    },
                  ]}
                >
          ...
          {needAssistance && (
            <View style={styles.assistWarning}>
              ...
              <Text style={{ fontSize: 12, color: TechColors.amber, flex: 1 }}>
                Admin will be notified immediately that this job needs
                additional support.
              </Text>
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  assistWarning: {
    ...
    backgroundColor: TechColors.amberBg,
